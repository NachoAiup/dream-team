...
const positionsY = ["8%", "30%", "30%", "60%", "60%"];
const positionsX = [0, "-50%", "50%", "-50%", "50%"];
  ...
  return (
    <>
      <button
        ...
        style={{ bottom: positionsY[idx], left: positionsX[idx] }}
        className={`z-10 w-20 h-20 2xl:w-24 2xl:h-24 absolute inset-x-0 flex items-center justify-center hover:bg-opacity-85 p-0 2xl:p-2 rounded-xl overflow-hidden bg-gray-400 bg-opacity-70 mx-auto`}
      >
        {playerSelected ? (
          <div className="flex items-center flex-col gap-1">
            <div className="w-8 2xl:w-12">
              <ImageWithFallback
                width={50}
                height={50}
            ...
            <p className="text-black text-xs 2xl:text-sm font-bold line-clamp-2">
